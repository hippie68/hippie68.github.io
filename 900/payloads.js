...
addPayload("goldhen_v2.4b18.bin", "GoldHEN 2.4 BETA 18", "Latest changes: added Cheat Downloader, improved Rest Mode support, fixed server checkboxes bug, moved Klog server to userland.", "goldhen");
