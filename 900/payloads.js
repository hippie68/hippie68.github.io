...
addPayload("goldhen_v2.4b17.3.bin", "GoldHEN 2.4 BETA 17.3", "Latest changes: improved BinLoader server (more payloads) and Klog server (network disconnection), declarative network servers configuration.", "goldhen");
