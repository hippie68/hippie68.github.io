...
addPayload("gta5_expulsion_beta_4_v1.38.bin.bz2", "GTA 5 Expulsion Beta 4 (v1.38)", "Enables a mod menu in GTA 5, which you can activate in-game by pressing L1 + Square. Only works with the stated game version.", "gta5");
...
addPayload("linux_1gb_pro.bin", "Linux PS4 Pro (1 GB)", "Loads Linux from a prepared USB storage device. Leaves Linux with 7 GB of RAM, as 1 GB will be used for graphics. Do not use this payload during Linux installation.", "ps4_pro");
